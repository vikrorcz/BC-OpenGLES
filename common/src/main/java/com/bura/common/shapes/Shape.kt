...
abstract class Shape(
    ...
    fun isOnScreen(): Boolean {
        val eyeX = engine.camera.eyeX
        val eyeY = engine.camera.eyeY
        val eyeZ = engine.camera.eyeZ
        val shapeX = x
        val shapeY = y
        val shapeZ = z

        val cameraDirectionX = engine.camera.lookX - eyeX.toDouble()
        val cameraDirectionY = engine.camera.lookY - eyeY.toDouble()
        val cameraDirectionZ = engine.camera.lookZ - eyeZ.toDouble()
        ...
        val deltaX = shapeX -eyeX.toDouble()
        val deltaY = shapeY -eyeY.toDouble()
        val deltaZ = shapeZ -eyeZ.toDouble()
